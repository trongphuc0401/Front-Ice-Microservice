package com.frontice.auth_service.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, VerificationEmailEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
                new JsonDeserializer<>(VerificationEmailEvent.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, VerificationEmailEvent> kafkaListenerContainerFactory() {
